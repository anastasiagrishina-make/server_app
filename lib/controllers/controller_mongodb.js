...
//List
const listTasks_Mongo = async (req, res) => {
...
const listAuthors_Mongo = async (req, res) => {
    const query = req.query.q
    const sort_by = req.query["sort_by"]
...
//Get
const getTask_Mongo = async (req, res) => {
    const {id} = req.params;
...
//Create
const createTask_Mongo = async (req, res) => {
...
//Update
const updateTask_Mongo = async (req, res) => {
    const task = req.body;
...
//Delete
const deleteTask_Mongo = async (req, res) => {
    const {id} = req.params;
